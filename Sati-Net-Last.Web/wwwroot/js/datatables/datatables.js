 ...
 *   https://datatables.net/download/#bs5/dt-2.3.8/af-2.7.1/b-3.2.6/cc-1.2.1/date-1.6.3
 *
 * Included libraries:
 *   DataTables 2.3.8, AutoFill 2.7.1, Buttons 3.2.6, ColumnControl 1.2.1, DateTime 1.6.3
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "bs5/dt-2.3.8/af-2.7.1/b-3.2.6/cc-1.2.1/date-1.6.3",
