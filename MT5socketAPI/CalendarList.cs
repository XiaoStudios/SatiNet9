...
namespace MTsocketAPI.MT5
{
	...
	public class Event
	{
		...
		public string EVENT_FREQUENCY { get; set; } = string.Empty;
		public int EVENT_ID { get; set; }
		public string EVENT_IMPORTANCE { get; set; } = string.Empty;
		public string EVENT_MULTIPLIER { get; set; } = string.Empty;
		public string EVENT_NAME { get; set; } = string.Empty;
		public string EVENT_SECTOR { get; set; } = string.Empty;
		public string EVENT_SOURCE_URL { get; set; } = string.Empty;
		public string EVENT_TIME_MODE { get; set; } = string.Empty;
		public string EVENT_TYPE { get; set; } = string.Empty;
		public string EVENT_UNIT { get; set; } = string.Empty;
