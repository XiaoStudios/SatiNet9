...
namespace MTsocketAPI.MT5
{
    public class Asset
    {
        ...
        public double TRADE_TICK_VALUE { get; set; }
        public double TRADE_TICK_VALUE_PROFIT { get; set; }
        public double TRADE_TICK_VALUE_LOSS { get; set; }
        ...
        public double VOLUME_LIMIT { get; set; }
